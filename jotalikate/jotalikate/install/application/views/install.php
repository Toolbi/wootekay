...
<title>Carpooling Script Installation v 2.0</title>
<!-- must have -->
...
<div class="container-main margintop140 marginbottom40">
	<div class="container">
		...
		<?php endif;?>
			<h2 class="size40 bold">Installing Carpooling Script v 2.0</h2>
            <?php echo form_open('/');?>			
            ...
            <div class="para">
            <p>The Step-6 of installation guide will hold good only for first version. This section has been given for the purpose of testing, using a sample data, which is one time only. Since you will be downloading version 2.0, and not the first version, do not select this option.</p> 
            </div>
            <div class="row fleft padding10 blue-bg marginbottom40">            
				<div class="padding10 fleft width100">
					<ul class="con-main">						
